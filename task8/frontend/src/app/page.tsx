...
export default function Home() {
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [debouncedSearchTerm, selectedCategory, sort, minPrice, maxPrice]);
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="container mx-auto p-4">
        {/* Панель фильтров */}
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8 bg-white p-4 rounded-lg shadow">
          <input
            type="text"
